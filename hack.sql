...
--
-- Хост: 127.0.0.1:3306
-- Время создания: Май 19 2018 г., 15:50
...
CREATE TABLE IF NOT EXISTS `cases` (
  ...
  `linc` varchar(255) CHARACTER SET utf8 NOT NULL,
  PRIMARY KEY (`id_case`)
...
INSERT INTO `commands` (`id_command`, `name`, `date_of_formation`, `score`, `description`) VALUES
(1, '6 КУБИКОВ', '2018-05-19', 100, 'Веселая и находчивая команда из Санкт-Петербурга!'),
(2, '4fun', '2018-05-09', 0, '');
...
INSERT INTO `user_hack` (`id`, `id_user`, `id_hack`, `id_command`, `winner`) VALUES
(1, 2, 1, 1, -1),
(2, 1, 1, 1, -1),
(3, 2, 2, 2, -1);
...
INSERT INTO `user_info` (`id`, `id_user`, `name`, `lastname`, `about`, `sex`, `img`) VALUES
(1, 2, 'Поляков Александр', 'Юрьевич', 'Я успешный и находчивый. 5 лет занимаюсь пронраммированием web-приложений. ', 1, 'images/usesrs_avatar/avatar_incognito.jpg');
COMMIT;
